...
//add to matrices
// let a = ["albin", "asif", "abhijith"];
// let b = ["abin", "akhil", "arjun"];
// a.push(...b);
// console.log(a);

//rest parameters--> to pass indefinite number of argument to a funvtion

// console.log(add(3, 4, 5, 55, 34, 34, 23));
// function add(...num) {
//   let total = 0;
//   for (let n of num) {
//     total += n;
...
//CALLBACK
/**
 * to pass function as a parameter
 * one function wait for the other function
 */
